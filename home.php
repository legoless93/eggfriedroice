            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Blog</a>
                        </li>
                        <li>
        ...
        ";
         ?>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i> My Circles
                        </div>
                        <div class="panel-body">
                          <div class="list-group">
                              <a href="#" class="list-group-item">
                                  <i class="fa fa-user fa-fw"></i> Circle 1
                                  </span>
                              </a>
                              <a href="#" class="list-group-item">
                                  <i class="fa fa-user fa-fw"></i> Circle 2
                                  </span>
                              </a>
                              <a href="#" class="list-group-item">
                                  <i class="fa fa-user fa-fw"></i> Circle 3
                                  </span>
                              </a>
