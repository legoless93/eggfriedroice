        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html">username's photos</a>
                </div>
                <!-- /.navbar-header -->
                            ...
                            <li>
                                <a href="#">
                                    <div>
                                        ...
                                        <div class="progress progress-striped active">
                                            <div class="progress-bar progress-bar-warning" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="
    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href=""><i class = "fa fa-dashboard fa-fw"></i>Blog</a>
                </li>
                <li>
                    <a href="collection.html"><i class = "fa fa-dashboard fa-fw"></i>Photo</a>
                </li>
                <li>
                    <a href=""><i class = "fa fa-dashboard fa-fw"></i>Friend</a>
                </li>
                <li>
                    <a href=""><i class = "fa fa-dashboard fa-fw"></i>Circle</a>
                </li>
                <li>
                    <a href=""><i class = "fa fa-dashboard fa-fw"></i>Settings</a>
                </li>
            </ul>
        </div>
        <!-- /.sidebar-collapse -->
    ...
    <div class="container-fluid">
        <div class="row text-center">
            <div class="container-fluid text-left" style="margin-top:30px;">
                                            ...
                                            <div class="panel-body">
                                                <form action="" method="post">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="collectionname" type="string" class="form-control" placeholder="enter your collection name">
                                                    </div>
                                                    <div class="form-group">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12  hero-feature">
                                <div class="thumbnail">
                                    ...
                                    <div class="caption">
                                        <h5>Summer trip</h5>
                                        <h6>description</h6>
                                        <a href="photo.html" class="btn btn-default">Edit</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12  hero-feature">
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="photo">
                            <div role="tabpanel" class="tab-pane fade in active" id="collection">
                                            ...
                                            <div class="collapse" id="addphoto">
                                                <div class="panel-body">
                                                    ...
                                                    <form action="uploadaction.php" method="post" enctype="multipart/form-data" class="col-lg-12 col-md-12 col-sm-12">
                                                        ...
                                                        <input type="file" name='myFile' equired="required"/>
                                                        <!-- <input type="file" name="myFile"  accept="image/jpeg,image/gif,image/png"/><br /> -->
                                                        <input  class="btn btn-success" style="margin-top:10px;" type="submit" value="Upload" r />
                                                    </form>
                                                </div>
                                            </div>
                                            <hr>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12  hero-feature">
                                    <div class="thumbnail">
                                        <a href="#">
                                            <img class="img-responsive" src="uploads/3ef477f981c762601200ac5443fcd235.jpeg" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
                ...
                <!-- /.row -->
                <nav class="text-center col-lg-12 col-md-12 col-xs-12 thumb ">
                    <ul class="pagination">
                        <li>
